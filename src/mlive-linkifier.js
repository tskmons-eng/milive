(() => {
    ...
    async function Main() {
        ...
        const siteSearchBridgeState = {
            arai: { pendingRunning: false, pendingApplied: false, pendingRetryTimer: null },
        ...
        async function applySiteSearchBridgePending(adapter) {
            ...
            try {
                ...
                const restoreResult = adapter.restoreCondition(condition, currentMode);
        ...
        function getAraiSearchBridgeAdapter() {
            return {
                ...
                buildId: "arai-name-strict-ready-20260710",
